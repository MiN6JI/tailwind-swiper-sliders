        ...
        <div class="w-full lg:w-1/2 text-white p-6 space-y-6">
            ...
            <div class="w-full flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <div class="flex justify-center items-center">
                    <img src="../assets/global-network.png" alt="network" width="50px" height="50px">
                </div>
                <div>
                    <h2 class="text-lg lg:text-xl font-bold capitalize">Network Configuration</h2>
                    <p class="text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum voluptatum soluta quisquam nobis autem veniam.</p>
                </div>
            </div>
            <div class="w-full flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <div class="flex justify-center items-center">
